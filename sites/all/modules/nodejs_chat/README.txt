...
To install the NodeJS Chat module:
 ...
 4. If you're a site builder and just want to use the module's default features,
    you need to configure your Node JS Server (from the nodejs module) to use
    the "nodejs_chat.module.js" extension that comes with this module. To do so:

    4.1 Go to the "extensions" folder of this module, and grab the
        "nodejs_chat.module.js" file.

    4.2 Go to the folder where you've placed the Node JS Server (this is, the
        "server.js" file from the nodejs_chat module), and paste the file there.

    4.3 Enable the extension in your Node JS Server config. So, in the file
        "nodejs.config.js", look for this line:
    ...
    4.4 Make sure that at least either the property "clientsCanWriteToChannels"
        or the property "clientsCanWriteToClients" is set to true in the
        "nodejs.config.js" file of your Node JS Server.

    4.5 If the Node JS Server was running, restart it.
